...
class ControllerAccountInvoice extends Controller {
	public function index() { 
		...
		if ($order_info) {
			...
			$this->data['text_deliverydate'] = $this->language->get('text_deliverydate'); // Mod Delivery Date
			...
			if($order_info['deliverydate']==='0000-00-00') { 
        		$this->data['deliverydate'] = 'N/A'; 
    		} else {
				$this->data['deliverydate'] = strftime('%a %d %b, %Y', strtotime($order_info['deliverydate']));
			}
