...
class ControllerCheckoutGuestStep2 extends Controller {
	private $error = array();
  	...
  	public function index() {
		...
		$this->data['deliverydate_noweekends'] = $this->config->get('deliverydate_noweekends');
		...
		if (isset($this->request->post['deliverydate'])) {
			...
			$this->data['deliverydate'] = date('Y-m-d',strtotime('+'.$this->config->get('deliverydate_interval_days').' day'));
		}
		// End:Mod Delivery Date
