...
<?php } else { ?>
  <iframe src="//www.facebook.com/plugins/likebox.php?href=<?php echo $fblikeboxcode; ?>&amp;width=180&amp;height=320&amp;colorscheme=light&amp;connections=12&amp;show_faces=true&amp;border_color&amp;stream=false&amp;header=false" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:182px; height:320px;" allowTransparency="true"></iframe>
<?php } ?>
